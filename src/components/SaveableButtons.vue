<template>
  <div class="saveable">
    ...
    <div v-if="tracked">
      <button v-on:click="onSave" :disabled="!saveable"><span class="icon-save hide-high"></span><span class="hide-low" v-__>save</span></button>
      <button v-on:click="onRevert" :disabled="!saveable"><span class="icon-revert hide-high"></span><span class="hide-low" v-__>revert</span></button>
      <button v-on:click="onDelete" v-if="deletable"><span class="icon-delete hide-high"></span><span class="hide-low" v-__>delete</span></button>
    </div>
  </div>
</template>
