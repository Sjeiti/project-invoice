...
console.log('commander',commander.source); // todo: remove log
utils.read(commander.source)
    ...
    .then(result=>{
      ...
      let element = document.querySelector('body>*') // body.firstChild.outerHTML
      let fragment = document.createDocumentFragment()
      // console.log('document',document.documentElement.firstChild); // todo: remove log
      console.log('element',element); // todo: remove log
      console.log('element.nextSibling',element.nextSibling); // todo: remove log
      console.log('element.nextElementSibling',element.nextElementSibling); // todo: remove log
      console.log('fragment',fragment); // todo: remove log





                // jsdom.env(Object.assign(jsdomOptions || {}, {
                //     html: contents.join(''),
                //     done: (err, window) => {
                ...
                //         ['href', 'search'].forEach(prop => {
                //             Object.defineProperty(location, prop, {
                //                 writable: true,
                //                 value: location.href
                //             });
                //         });
                //         init && init(err, window);
                //         done();
                //     }
                // }))
      // console.log('dom',dom); // todo: remove log
    })
